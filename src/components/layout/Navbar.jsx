...
export default function Navbar() {
  const [dark, setDark] = useState(true); // always dark in this theme
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      scrolled ? 'backdrop-blur-xl bg-black/30 border-b border-white/10 py-3' : 'py-5'
    }`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <Link to="/" className="text-2xl font-bold gradient-text">GitFolio</Link>
